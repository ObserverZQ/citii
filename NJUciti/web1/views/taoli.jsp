                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse cl-effect-13" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="taoli.jsp" class="active">套利组合</a></li>
                ...
                <div id="resultPage">
                    <div class="container2 effect taoli">
                        <div class="recommend">
                            ...
                            <!--</div>-->
                            <h3>套利组合推荐</h3>
                            <table class="table table-bordered g-table" style="text-align: center;">
                                <thead>
                                <tr>
                                    <th>组合号</th>
                                    <th>代码</th>
                                ...
                                <tbody style="background-color: rgba(15,81,143,.3); color: #eee; vertical-align: middle;">
                                <tr>
                                    <td rowspan="2">1</td>
                                    <td>SR801</td>
                                    <td>6713</td>
                        ...
                        <div class="total effect">
                            <h3 style="margin: 15px auto 10px; font-size: 16px">下单</h3>
                            ...
                            <form action="#" method="post">
                                <span style="display:inline-block;margin-right: 35px;">下单手数</span>
                                <input type="text" class="password" name="amount" placeholder="" required="">
                                <span>所需保证金</span>
                                <input type="text" class="password" name="required" placeholder="" required="">
                                <div class="clear"></div>
                                <input type="submit" class="a_demo_one submit" name="submit" value="确认" >
                            </form>
                        </div>
